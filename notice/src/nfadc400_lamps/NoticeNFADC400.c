...
#else
void NKNFADC400::NFADC400read_TTIME(int devnum, unsigned long mid, unsigned long ch, unsigned long nevt, unsigned char *data)
#endif
{
  unsigned long baseaddr, nch;
  unsigned long addr;
...
#else
void NKNFADC400::NFADC400dump_BUFFER(int devnum, unsigned long mid, unsigned long ch, unsigned long range, unsigned long page, unsigned char *data)
#endif
{
  unsigned long baseaddr, nch;
  unsigned long num;
...
#else
void NKNFADC400::NFADC400dump_TAG(int devnum, unsigned long mid, unsigned long ch, unsigned long range, unsigned long page, unsigned char *data)
#endif
{
  unsigned long baseaddr, nch;
  unsigned long num;
...
#else
void NKNFADC400::NFADC400read_TIMER(int devnum, unsigned long mid, unsigned char *data)
#endif
{
  unsigned long baseaddr;
  unsigned long addr;
...
#else
void NKNFADC400::NFADC400version_FPGA(int devnum, unsigned long mid, unsigned char *data)
#endif
{
  unsigned long baseaddr;
  unsigned long addr;
...
#else
void NKNFADC400::NFADC400version_CPLD(int devnum, unsigned long mid, unsigned char *data)
#endif
{
  unsigned long baseaddr;
  unsigned long addr;
...
#else
void NKNFADC400::NFADC400read_SN(int devnum, unsigned long mid, unsigned char *data)
#endif
{
  unsigned long baseaddr;
  unsigned long addr;
